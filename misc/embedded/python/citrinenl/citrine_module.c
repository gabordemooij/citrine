...
void citrine_connector(char* str) {
	...
	if (program == NULL) {
		printf("Kan programma niet lezen\n");
		return;
	}
...
static PyObject* citrine_eval_nl(PyObject* self, PyObject* args)
{
    char* value;
...
{
     {"citrine_eval_nl", citrine_eval_nl, METH_VARARGS, "evaluate Citrine expression"},
     {NULL, NULL, 0, NULL}
};
...
static struct PyModuleDef cModPyDem =
{
    ...
    "citrine_module_nl", "Embedded Citrine",
    -1,
    CitrineMethods
};
PyMODINIT_FUNC
PyInit_citrine_module_nl(void)
{
