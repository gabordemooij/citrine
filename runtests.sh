...
for i in $(find tests -name 'test*.ctr'); do
	...
	rm tests/runner1.ctr ; echo "Broom mode: 0." > tests/runner1.ctr ; cat ${fitem} >> tests/runner1.ctr
	rm tests/runner2.ctr ; echo "Broom mode: 1." > tests/runner2.ctr ; cat ${fitem} >> tests/runner2.ctr
	rm tests/runner3.ctr ; echo "Broom mode: 4." > tests/runner3.ctr ; cat ${fitem} >> tests/runner3.ctr
	rm tests/runner4.ctr ; echo "Broom mode: 8." > tests/runner4.ctr ; cat ${fitem} >> tests/runner4.ctr
