...
void ctr_initialize_world() {
	...
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( "characters" ),&ctr_string_characters );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( "toByteArray" ),&ctr_string_to_byte_array );
