...
void ctr_initialize_world() {
	...
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "ceiling" ), &ctr_number_ceil );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "round" ), &ctr_number_round );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "absolute" ), &ctr_number_abs );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "sine" ), &ctr_number_sin );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "cosine" ), &ctr_number_cos );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "exponent" ), &ctr_number_exp );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "squareRoot" ), &ctr_number_sqrt );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "tangent" ), &ctr_number_tan );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "arctangent" ), &ctr_number_atan );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "logarithm" ), &ctr_number_log );
	...
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "positive" ), &ctr_number_positive );
	ctr_internal_create_func(CtrStdNumber, ctr_build_string_from_cstring( "negative" ), &ctr_number_negative );
