...
void ctr_initialize_world() {
	...
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( "containsPattern:" ), &ctr_string_contains_pattern );
	...
	ctr_internal_create_func(CtrStdCommand, ctr_build_string_from_cstring( "remainingMessages:" ), &ctr_command_countdown );
