...
#define CTR_MSG_USAGE_G   "No tin sufisiente argumentonan. Uza: ctr -g file1.h file2.h"
#define CTR_MSG_USAGE_T   "No tin sufisiente argumentonan. Uza: ctr -t d.dict program.ctr"
